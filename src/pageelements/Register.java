...
//	WebElement logout;
	...
	public void register() {
		...
		Company.sendKeys("AmarRaja");
		Address.sendKeys("punganur");

		Country.click();
		select.click();

		State.sendKeys("Andhrapradesh");
		City.sendKeys("punganur");
		...
		Zipcode.sendKeys("517247");
		MobileNumber.sendKeys("9440668949");
